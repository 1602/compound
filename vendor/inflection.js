...
plural(/s$/i, "s");
plural(/sis$/i, "ses");
plural(/(ax|test)(es|is)$/i, "$1es");
plural(/(octop|vir)(i|us)$/i, "$1i");
plural(/(alias|status)(es)?$/i, "$1es");
plural(/(bu)s(es)?$/i, "$1ses");
plural(/(buffal|tomat)o(es)?$/i, "$1oes");
plural(/([ti])um$/i, "$1a");
plural(/(?:([^f])fe|([lr])f)$/i, "$1$2ves");
plural(/(hive)s?$/i, "$1s");
plural(/([^aeiouy]|qu)y$/i, "$1ies");
plural(/(matr|vert|ind)(?:ix|ex|ices)$/i, "$1ices");
plural(/([m|l])(ouse|ice)$/i, "$1ice");
plural(/^(ox)(en)?$/i, "$1en");
plural(/(quiz)(zes)?$/i, "$1zes");
plural(/(x|ch|ss|sh)(es)?$/i, "$1es");

singular(/s$/i, "")
singular(/([ti])(a|um)$/i, "$1um")
singular(/(o)es$/i, "$1")
singular(/(n)ews$/i, "$1ews")
singular(/((a)naly|(b)a|(d)iagno|(p)arenthe|(p)rogno|(s)ynop|(t)he)(sis|ses)$/i, "$1$2sis")
singular(/(^analy)(sis|ses)$/i, "$1sis")
singular(/([^f])ves$/i, "$1fe")
singular(/(hive)s?$/i, "$1")
singular(/(tive)s?$/i, "$1")
singular(/([lr])ves$/i, "$1f")
singular(/([^aeiouy]|qu)(y|ies)$/i, "$1y")
singular(/(s)eries$/i, "$1eries")
singular(/(m)ovies?$/i, "$1ovie")
singular(/([m|l])(ice|ouse)$/i, "$1ouse")
singular(/(bus)(es)?$/i, "$1")
singular(/(shoe)s?$/i, "$1")
singular(/(cris|ax|test)(is|es)$/i, "$1is")
singular(/(octop|vir)(i|us)$/i, "$1us")
singular(/(alias|status)(es)?$/i, "$1")
singular(/^(ox)(en)?/i, "$1")
singular(/(vert|ind)(ices|ex)$/i, "$1ex")
singular(/(matr)(ices|ix)$/i, "$1ix")
