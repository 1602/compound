...
function Compound(app, root) {
    ...
    this.map = this.routeMapper = new Map(app, bridge.uniCaller.bind(bridge));
 ...
 */
Compound.prototype.version = require('../package.json').version;
