...
(function () {
    ...
    function initGenerator (args) {
        ...
        createFileByTemplate('config/environment',              db + '/config/environment', replaceViewEngine);
        createFileByTemplate('config/environments/test',        db + '/config/environments/test');
        createFileByTemplate('config/environments/development', db + '/config/environments/development');
        createFileByTemplate('config/environments/production',  db + '/config/environments/production');
        createFileByTemplate('config/database.json',            db + '/config/database.json', replaceAppname);
