...
function Controller(name) {
    ...
    this._baseLayout = this._layout = layoutsCache[name];
 ...
 * @private
 */
Controller.prototype.perform = function (actionName, req, res) {
    res.info = {
