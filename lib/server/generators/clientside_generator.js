...
CliensideGenerator.prototype.browserify = function browserify() {
    var generator = this;
    try {
...
CliensideGenerator.prototype.watch = function watch(file, ignoreSelf) {
    var generator = this;
    if (!required) return;
...
CliensideGenerator.prototype.rebuild = function rebuild() {
...
CliensideGenerator.prototype.make = function make(what) {
    var s = this.app.compound.structure;
    var cs = s[what];
