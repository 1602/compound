...
GeneratorUtilities.prototype.getAutoloadModules = function() {
  var autoloadModules = '';
  if(this.options.css === 'stylus' && this.options.nib) {
    autoloadModules += ',\n    \'co-nib\'';
  }
  return autoloadModules;
};

GeneratorUtilities.prototype.getDependencies = function() {
  var dependencies = '';
  if(this.options.css === 'stylus' && this.options.nib) {
    dependencies += '  , "co-nib": "latest"\n'
  }
  return dependencies;
};
