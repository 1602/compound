...
CompoundServer.prototype.init = function () {
    ...
    if (compound.app.enabled('clientside')) {
        ...
        if (b.fake) {
            ...
            b.fake('express', path.resolve(__dirname + '/../client/application.js'));
            b.fake('fs', path.resolve(__dirname + '/../client/fs.js'));
            b.fake('module', __dirname + '/../../templates/blank.js');
        } else {
            console.log('install browserify from fork anatoliychakkaev/node-browserify');
        }
        ...
        b.bundle({insertGlobals: true, detectGlobals: false, ignoreMissing: true}, tryMinify);
    }
