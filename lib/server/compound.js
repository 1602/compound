 ...
 */
CompoundServer.prototype.injectMiddlewareBefore = function(anchor, middleware) {
    ...
    this.injectMiddlewareAt(anchorPosition, middleware);
 ...
 * @return {Boolean} - is anchor middleware was found.
 */
CompoundServer.prototype.injectMiddlewareAfter = function(anchor, middleware) {
    var mod = this.app, anchorPosition;
    mod.stack.forEach(function (r, i) {
        if (r.handle === anchor || r.handle.name === anchor) {
            anchorPosition = i;
    ...
    this.injectMiddlewareAt(anchorPosition + 1, middleware);
    return 'undefined' !== typeof anchorPosition;
};
