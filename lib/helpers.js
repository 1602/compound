    ...
    block({
        ...
        checkbox: function (name, params) {
            ...
            if (params.checked === undef) {
                params.checked = resource[name] || undef;
            }
            return HelperSet.prototype.input_tag({
                name: makeName(name),
                id: makeId(name),
        ...
        select: function (name, options, params) {
            ...
            if (params.blank !== undef) {
                var emptyOption = {};
                emptyOption[optionFieldname] = params.blank
                   emptyOption[optionFieldvalue] = '';
            ...
            for (var optionsNr in options) {
                ...
                if (Object.prototype.toString.call(optionSelected) === '[object Array]') {
                    // This is an array
                    for (var optionsSelectNr in optionSelected) {
                        // Compare value against optionSelected. Cast to String as these might be objects.
                        if (String(option[optionFieldvalue]) == String(optionSelected[optionsSelectNr])) {
                    ...
                    // Compare value against optionSelected. Cast to String as these might be objects.
                    if (String(option[optionFieldvalue]) == String(optionSelected)) {
                        optionParameters.selected = 'selected';
                    }
                }
