...
HelperSet.prototype.fieldsFor = function (resource, formParams, block) {
    ...
    var blockHelper = {
        ...
        select: function (name, options, params) {
            ...
            var escapeHtml = params.escapeHtml || true;
            ...
            for (var optionsNr in options) {
                ...
                var option_value = option[optionFieldname];

                if (escapeHtml == true) {
                    option_value = sanitizeHTML(option[optionFieldname])
                }

                // Generate the option Tags
                innerOptions += HelperSet.prototype.option_tag(option_value, optionParameters)
            }
            // Render the select
