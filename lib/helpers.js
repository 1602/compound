...
HelperSet.prototype.fieldsFor = function (resource, formParams, block) {
    ...
    var blockHelper = {
        ...
        textarea: function (name, params) {
            ...
            return HelperSet.prototype.textareaTag(sanitizeHTML(value), {name: makeName(name), id: makeId(name, params)}, params);
        },
        /*
        ...
        select: function (name, options, params) {
            ...
            // Render the select
            return HelperSet.prototype.selectTag(innerOptions, {name: makeName(name), id: makeId(name, params)}, params);
        }
    };
