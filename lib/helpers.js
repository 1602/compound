...
HelperSet.prototype.fields_for = function (resource, block) {
    ...
    block({
         ...
         * @example
         * <strong>In ejs:</strong>
         * <code>&lt;%- form.select("state", states, {fieldname: 'name', fieldvalue: '_id'}) %&gt;</code>
         * <strong>Or:</strong>
         * <code>&lt;%- form.select("state", states, {fieldname: 'name', fieldvalue: '_id', select: item.state._id, size: 3}) %&gt;</code>
         * <strong>Or:</strong>
         * <code>&lt;%- form.select("state", states, {fieldname: 'name', fieldvalue: '_id', select: item.state._id, size: 3, multiple: false}) %&gt;</code>
         * <strong>Or:</strong>
         * <code>&lt;%- form.select("state", states, {fieldname: 'name', fieldvalue: '_id', select: item.state._id, size: 3, blank:'Select status'}) %&gt;</code>
         * <strong>Or:</strong>
         * <code>&lt;%- form.select("state", states, {fieldname: 'name', select: item.state.name, size: 3, blank:'Select status'}) %&gt;</code>
         */
