...
module.exports = function i18n(compound) {
    ...
    function T(global) {
        ...
        function translate(path, locale, defaultValue) {
            var translation = compound.__localeDate[locale], substitute;
            ...
            if (!translation && compound.parent) {
    ...
    T.localeSupported = function(localeName) {
        return !!compound.__localeDate[localeName];
    };
};
...
function addTranslation(lang, compound) {
    Object.keys(lang).forEach(function(localeName) {
        ...
        compound.__localeDate[localeName] = compound.__localeDate[localeName] || {};
        Object.keys(translations).forEach(function(namespace) {
            compound.__localeDate[localeName][namespace] = translations[namespace];
        });
    });
}
