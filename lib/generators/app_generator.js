...
AppGenerator.prototype.copyFiles = function () {
  ...
  [
    ...
    'app/controllers/application_controller.{{ CODE }}',
    'app/views/layouts/application_layout.{{ TPL }}',
  ...
  self.copyFile('config/database_{{ DBDRIVER }}.{{ DATA }}', 'config/database.{{ DATA }}', templateVariables);
};
