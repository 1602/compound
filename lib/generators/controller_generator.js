...
ControllerGenerator.prototype.createDirectoryStructure = function () {
  ...
  [ 
    ...
    'app/helpers/',
    'app/views/',
    'app/views/' + this.options.controllerName
...
ControllerGenerator.prototype.generateController = function() {
  ...
  this.copyKontroller('controller_eval.{{ CODE }}', 'app/controllers/' + this.options.controllerName + '_controller.{{ CODE }}', templateVariables)
};
