...
Controller.prototype.render = function render(view, params, callback) {
    ...
    if (params.isMobile && params.isMobile === true) {
        view = '_mobile_' + view;
    }
    else if (params.isTablet && params.isTablet === true) {
        view = '_mobile_' + view;
    }
    ...
    else if (layout && params.isMobile && params.isMobile === true) {
        layout = '_mobile_' + layout;
    }
    else if (layout && params.isTablet && params.isTablet === true) {
        layout = '_mobile_' + layout;
    }
