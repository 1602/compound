...
function Railway(app) {
    ...
    this.eventserver = new EventEmitter2({
      ...
      maxListeners: 25, // the max number of listeners that can be assigned to an event, defaults to 10.
    });
...
exports.createServer = function (options) {
    ...
    return app;
    //return function(){ return require("http").createServer; };
};
...
function evalInContextOf(app, filename) {
	...
	/*
	console.log("onRailway:evalInContextOf", filename);
	try {
